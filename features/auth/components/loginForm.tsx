        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <TextInput
              ...
              className={`border-b border-neutral-medium-gray p-3 text-black bg-neutral-light-gray/50 rounded-full border max-h-[100px] ${isLoading ? 'opacity-50' : ''}`}
          ...
          render={({ field: { onChange, value } }) => (
            <View className="relative">
              <TextInput
                ...
                className={`border-b border-neutral-medium-gray p-3 pr-12 text-black bg-neutral-light-gray/50 rounded-full border max-h-[100px] ${isLoading ? 'opacity-50' : ''}`}
                value={value}
